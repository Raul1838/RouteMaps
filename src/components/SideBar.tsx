...
export const SideBar = () => {
    ...
    return (
        <div className="card" style={{
            ...
            <NavLink to="/" className={`nav-link ${location.pathname === "/" ? "active" : ""}`} style={{ padding: '20px', textAlign: 'center', color: location.pathname === "/" ? "#0000FF" : "#000000" }}><i className="fas fa-map"></i></NavLink>
            ...
            <NavLink to="/pathways" className={`nav-link ${location.pathname.startsWith("/pathways") ? "active" : ""}`} style={{ padding: '20px', textAlign: 'center', color: location.pathname.startsWith("/pathways") ? "#1faf09" : "#000000" }}><i className="fas fa-route"></i></NavLink>
        </div>
    );
};
